...
def generate(df: pd.DataFrame, end_date: datetime.date) -> tuple[IncomeStatement, BalanceSheetInCent, list[Holding]]:
...
def main():
    ...
    parser.add_argument("--output-dir", required=False, default=".", help="Directory for generated PDF files")
